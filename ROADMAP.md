...
| CI | `npm run ci` green (typecheck + 79 tests + `npm pack --dry-run`) |
...
| `tests/*.test.mjs` | 79 tests (engine, store, schema, discovery, scaffold, widget, status, history, agents, commands, handoff, kebab-case, model-routing, review-contract, extension-registration, smoke) |
