...
| `tests/*.test.mjs` | 91 tests (engine, store, schema, discovery, scaffold, widget, status, history, agents, commands, handoff, kebab-case, model-routing, review-contract, extension-registration, smoke) |
